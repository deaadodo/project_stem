...
Name<br /><input type="text" name="p_name" value="<?php echo "$row[pr_name]"?>" /><br />

Username<br /><input type="text" name="p_username" value="<?php echo "$row[pr_username]"?>" /><br />

Password<br /><input type="text" name="p_password" value="<?php echo "$row[pr_password]"?>" /><br /><br />
